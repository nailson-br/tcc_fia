...
data_frame['classe'] = ["identificação"] * 5 + ["População"] * 8 
                        + ["Educação"] * 57 + ["Renda"] * 33 
                        + ["Trabalho"] * 35 + ["Habitação"] * 8 
                        + ["Educação"] * 2 + ["Habitação"] * 2 
                        + ["Trabalho"] + ["Saúde"] * 2 
                        + ["Trabalho"] * 4 + ["Habitação"] 
                        + ["População"] * 36 + ["Trabalho"] * 4 
                        + ["População"] * 33 + ["IDH"] * 6
